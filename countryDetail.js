...
const CountryNameForDetail = document.querySelector(".country-name h2");
...
CountryNameForDetail.innerText = countryName.toUpperCase();
fetch(`https://restcountries.com/v3.1/name/${countryName}`)
  .then((res) => res.json())
  .then(([data]) => {
    console.log(data);
    // nativeName.innerText=`${data.name.nativeName.eng.official}`
    ...
    topLevelDomain.innerText=`${data.tld}`
